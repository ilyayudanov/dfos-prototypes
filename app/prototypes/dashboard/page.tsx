    ...
    <>
      ...
      <div className="h-screen bg-black overflow-hidden">
        <div className="flex h-full">
          {/* Left Sidebar */}
          <div className="w-[355px] bg-black border-r border-gray-800 flex flex-col">
            {/* Sidebar Header */}
          ...
          <div className="flex-1 relative">
            ...
            <div className="relative z-10 p-4">
              <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-3 mx-4">
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button variant="ghost" className="text-xl font-semibold text-black tracking-tight hover:bg-gray-100 h-auto p-2">
                      {selectedSpace}
            ...
            <Card className="bg-white/90 backdrop-blur-sm">
              <CardContent className="p-4">
                ...
                <div className="flex flex-wrap gap-1">
                  ...
                  <Badge variant="secondary" className="text-xs">DropdownMenu</Badge>
                  <Badge variant="secondary" className="text-xs">FloatingCards</Badge>
                </div>
                <p className="text-xs text-slate-600 mt-2">
                  Desktop-first dashboard with space management
                </p>
              </CardContent>
            </Card>
          </div>
